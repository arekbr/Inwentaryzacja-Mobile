...
- Lokalne sync discipline (multi-device): `feedback_git_sync_discipline.md` + naprawa narrow refspec na carbon
...
- Dwa device dev: mak (Mac Studio Apple Silicon, MariaDB 12.2.2) + carbon (Linux laptop, MariaDB 11.8.6)
